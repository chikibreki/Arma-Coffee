class base {
    displayName = "base";
    uniform[] = {"MNP_CombatUniform_RU_Med_B","MNP_CombatUniform_RU_Med"};
...
class r : base {
    ...
    headgear[] = {"CUP_H_RUS_6B46","CUP_H_RUS_6B27_cover"};
	...
	magazines[] +=
    {
        LIST_10("CUP_30Rnd_TE1_Green_Tracer_762x39_AK47_bakelite_M"),
        LIST_2("rhs_mag_rgd5"),
