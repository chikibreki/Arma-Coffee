...
class base {
    displayName = "base";
    uniform[] = {"VSM_M81_Crye_SS_Camo","VSM_M81_Crye_Camo"};
    vest[] = {"VSM_LBT6094_breacher_M81","VSM_LBT6094_operator_M81","VSM_LBT6094_MG_M81"};
    backpack[] = {"VSM_M81_Backpack_Kitbag"};
    headgear[] = {"VSM_M81_OPS_2","VSM_M81_OPS"};
	hmd[] = {};
    primaryWeapon[] = {};
    primaryAttachments[] = {};
...
class r : base 
{
	...
	vest[] = {"VSM_LBT6094_breacher_M81"};
	primaryWeapon[] = {"CUP_arifle_HK416_Wood"};
	scope[] = {"CUP_optic_microt1_od"};
    attachment[] = {"cup_acc_anpeq_15_flashlight_od_l"};
...
class g : r
{
    ...
    primaryWeapon[] = {"CUP_arifle_HK416_AGL_Wood"};
	attachment[] = {"carls_llm_irlaser_cup_anpeq2_flash_od_top"};
    magazines[] +=
    {
...
class car : r
{
    ...
    primaryWeapon[] = {"CUP_arifle_HK416_CQB_Wood"};
	scope[] = {"CUP_optic_microt1_od"};
    attachment[] = {"cup_acc_anpeq_15_flashlight_od_l"};
	silencer[] = {"cup_muzzle_snds_m16_camo"};
	primaryAttachments[] = {};
