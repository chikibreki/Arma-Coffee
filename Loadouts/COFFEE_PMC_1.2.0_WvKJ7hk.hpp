...
class base {
    ...
    sidearmAttachments[] = {};
    magazines[] = {};
    items[] = {"ACRE_PRC343","ACE_elasticBandage","ACE_elasticBandage","ACE_packingBandage","ACE_packingBandage","ACE_IR_Strobe_Item","ACE_morphine","ACE_splint","ACE_tourniquet","ACE_Chemlight_White","CUP_NVG_GPNVG_black","CUP_G_ESS_BLK_Scarf_Face_Blk","murshun_cigs_cigpack","murshun_cigs_lighter","ACE_CableTie"};
    linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemGPS"};
};
class r : base {
    displayName = "rifleman";
    headgear[] = {"CUP_H_OpsCore_Tan"};
	primaryWeapon[] = {"CUP_arifle_M4A1_SOMMOD_tan"};
    attachment[] = {"CUP_acc_ANPEQ_2_Flashlight_Coyote_L"};
	secondaryAttachments[] = {"CUP_muzzle_snds_M16_coyote"};
    sidearmAttachments[] = {};
	magazines[] +=
    {
        LIST_4("CUP_30Rnd_556x45_PMAG_COYOTE_PULL_Tracer_Red"),
        LIST_6("CUP_30Rnd_556x45_PMAG_COYOTE_PULL"),
...
class ar : r
{
	...
	attachment[] = {"CUP_muzzle_snds_M16_coyote"};
    bipod[] = {};
