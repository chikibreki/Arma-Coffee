...
class base {
    displayName = "base";
    uniform[] = {"CUP_U_B_BAF_DPM_UBACSLONG_Gloves"};
    vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Empty"};
    backpack[] = {};
    headgear[] = {};
    primaryWeapon[] = {};
    primaryAttachments[] = {};
...
class r : base {
    ...
    primaryAttachments[] = {"CUP_acc_LLM","CUP_optic_HoloBlack"};
	secondaryAttachments[] = {};
    sidearmAttachments[] = {};
    magazines[] = {"CUP_30Rnd_556x45_Stanag_L85","CUP_30Rnd_556x45_Stanag_L85","CUP_30Rnd_556x45_Stanag_L85","CUP_30Rnd_556x45_Stanag_L85","CUP_30Rnd_556x45_Stanag_L85","CUP_30Rnd_556x45_Stanag_L85","CUP_30Rnd_556x45_Stanag_L85","HandGrenade","HandGrenade","SmokeShell"};
...
class g : r
{
	...
	vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Grenadier"};
...
class car : r
{
	...
	primaryAttachments[] = {"cup_optic_microt1_low_coyote"};
};
class m : car
{
    displayName = "Medic";
	vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Medic"};
...
class ftl : g
{
	...
	vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Officer"};
...
class ar : r
{
	...
	vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_AutomaticRifleman"};
	backpack[] = {"CUP_B_Motherlode_MTP"};
    primaryWeapon[] = {"CUP_arifle_L86A2"};
	sidearmWeapon[] = {"CUP_hgun_Glock17"};
    magazines[] =
    {
        LIST_4("CUP_100Rnd_556x45_BetaCMag_ar15"),
		LIST_1("HandGrenade"),
		LIST_1("SmokeShell"),
		LIST_3("CUP_17Rnd_9x19_glock17")
    };
...
class dm : r
{
	...
	vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Scout"};
...
class vd : smg
{
    ...
    vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Crewman"};
    backpack[] = {"CUP_B_Motherlode_MTP"};
    linkedItems[] += {"ItemGPS"};
...
class eng : car //CHECK FOR COMPATIBILITY
{
	...
	vest[] = {"CUP_V_B_BAF_DPM_Osprey_Mk3_Engineer"};
    backpack[] = {"CUP_B_Motherlode_MTP"};
    magazines[] +=
    {
