...
class base {
    displayName = "base";
    uniform[] = {"OPTRE_UNSC_Marine_Uniform_SlimLeg"};
...
class crewman {
    displayName = "Crewman";
    uniform[] = {"OPTRE_UNSC_Navy_Uniform_Blue","OPTRE_UNSC_Navy_Uniform_Gray","OPTRE_UNSC_Navy_Uniform_Olive","OPTRE_UNSC_Navy_Uniform_Orange","OPTRE_UNSC_Navy_Uniform_Red","OPTRE_UNSC_Navy_Uniform_White","OPTRE_UNSC_Navy_Uniform_Yellow"};
...
class navyOfficer : crewman {
	displayName = "Navy Officer";
	uniform[] = {"OPTRE_UNSC_Dress_Uniform_White"};
	headgear[] = {"OPTRE_UNSC_Dress_Hat"};
...
class m : smg
{
    ...
    headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_MAR_MED"};
