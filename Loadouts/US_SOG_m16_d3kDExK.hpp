...
class base {
    ...
    backpack[] = {"CUP_O_RUS_Patrol_bag_Summer_Shovel","CUP_O_RUS_Patrol_bag_Summer","CUP_O_RUS_Patrol_bag_Green_Shovel","CUP_O_RUS_Patrol_bag_Green"};
...
class sl : ftl
{
	...
	headgear[] = {"CUP_H_USArmy_Helmet_M1_btp"};
	items[] += {"ACRE_PRC148"};
    linkedItems[] =
    {
        "ItemMap",
