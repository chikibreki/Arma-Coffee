...
class base {
    displayName = "base";
    uniform[] = {"OPTRE_UNSC_Army_Uniform_SNO","OPTRE_UNSC_Army_Uniform_SNO_SlimLeg","OPTRE_UNSC_Army_Uniform_R_SNO","OPTRE_UNSC_Army_Uniform_R_SNO_SlimLeg","OPTRE_UNSC_Army_Uniform_S_SNO","OPTRE_UNSC_Army_Uniform_S_SNO_SlimLeg"};
	vest[] = {"OPTRE_UNSC_M52A_Armor_Rifleman_SNO"};
    sidearmWeapon[] = {"OPTRE_M6G_SF"};
	sidearmAttachments[] = {"OPTRE_M6G_Scope","OPTRE_M6G_Flashlight"};
    headgear[] = {"OPTRE_UNSC_CH252_Helmet2_SNO"};
...
class g : r
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Grenadier_SNO"};
    magazines[] +=
    {
...
class m : smg
{
	...
	headgear[] = {"OPTRE_UNSC_CH252_Helmet2_SNO_MED"};
...
{
    displayName = "Sniper";
	vest[] = {"OPTRE_UNSC_M52A_Armor_Sniper_SNO"};
	headgear[] = {"OPTRE_UNSC_CH252_Helmet3_SNO"};
...
class pp : vd
{
    ...
    headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_SNO"};
	items[] += {"ACRE_PRC148"};
};
class pcc : vd
{
...
class sh : smg
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Breacher_SNO"};
