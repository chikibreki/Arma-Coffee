...
class base {
    displayName = "base";
    uniform[] = {"OPTRE_UNSC_Army_Uniform_URB","OPTRE_UNSC_Army_Uniform_URB_SlimLeg","OPTRE_UNSC_Army_Uniform_R_URB","OPTRE_UNSC_Army_Uniform_R_URB_SlimLeg","OPTRE_UNSC_Army_Uniform_S_URB","OPTRE_UNSC_Army_Uniform_S_URB_SlimLeg"};
...
class g : r
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Grenadier_URB"};
    magazines[] +=
    {
...
class m : smg
{
	...
	headgear[] = {"OPTRE_UNSC_CH252_Helmet2_URB_MED"};
...
class dm : base
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Marksman_URB"};
...
{
    displayName = "Sniper";
	vest[] = {"OPTRE_UNSC_M52A_Armor_Sniper_URB"};
	headgear[] = {"OPTRE_UNSC_CH252_Helmet3_URB"};
...
class pp : vd
{
    ...
    headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_URB"};
	items[] += {"ACRE_PRC148"};
};
class pcc : vd
{
...
class sh : smg
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Breacher_URB"};
