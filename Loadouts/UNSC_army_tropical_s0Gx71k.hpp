...
class base {
    displayName = "base";
    uniform[] = {"OPTRE_UNSC_Army_Uniform_TRO","OPTRE_UNSC_Army_Uniform_TRO_SlimLeg","OPTRE_UNSC_Army_Uniform_R_TRO","OPTRE_UNSC_Army_Uniform_R_TRO_SlimLeg","OPTRE_UNSC_Army_Uniform_S_TRO","OPTRE_UNSC_Army_Uniform_S_TRO_SlimLeg"};
...
class dm : base
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Marksman_WDL"};
...
class pp : vd
{
    ...
    headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_WDL"};
	items[] += {"ACRE_PRC148"};
};
class pcc : vd
{
...
class sh : smg
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Breacher_WDL"};
