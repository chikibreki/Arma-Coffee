...
class base {
    displayName = "base";
    uniform[] = {"CUP_U_O_CHDKZ_Kam_05","CUP_U_O_CHDKZ_Kam_02","CUP_U_O_CHDKZ_Kam_04"};
    ...
    sidearmAttachments[] = {};
    magazines[] = {};
    items[] = {"ACRE_PRC343","ACE_elasticBandage","ACE_elasticBandage","ACE_packingBandage","ACE_packingBandage","ACE_IR_Strobe_Item","ACE_morphine","ACE_splint","ACE_tourniquet","ACE_Chemlight_White","H_Cap_oli","G_Balaclava_oli"};
