class base {
    displayName = "base";
    uniform[] = {"CUP_U_O_RUS_Soldier_VKPO_MSV_EMR_gloves_pads"};
    vest[] = {"CUP_Vest_RUS_6B45_Sh117";"CUP_Vest_RUS_6B45_Sh117_Nut","CUP_Vest_RUS_6B45_Sh117_Del","CUP_Vest_RUS_6B45_Sh117_Del_Nut","CUP_Vest_RUS_6B45_Sh117_Full"};
    backpack[] = {"CUP_O_RUS_Patrol_bag_Summer"};
    headgear[] = {"CUP_H_RUS_6B47_v2_Summer","CUP_H_RUS_6B47_v2_GogglesClosed_Summer","CUP_H_RUS_6B47_v2_GogglesUp_Summer","CUP_H_RUS_6B47_v2_GogglesDown_Summer"};
    primaryWeapon[] = {};
    primaryAttachments[] = {};
...
class g : r
{
	...
	vest[] = {"CUP_Vest_RUS_6B45_Sh117_VOG";"CUP_Vest_RUS_6B45_Sh117_VOG_Nut","CUP_Vest_RUS_6B45_Sh117_VOG_Del","CUP_Vest_RUS_6B45_Sh117_VOG_Del_Nut","CUP_Vest_RUS_6B45_Sh117_VOG_Full"};
...
class UAV : car
{
    displayName = "UAV Operator"; //Use Vehicle UAV
