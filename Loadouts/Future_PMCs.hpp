...
class base {
    displayName = "base";
    uniform[] = {"vn_b_uniform_sog_01_03"};
    vest[] = {"CUP_V_I_RACS_Carrier_Rig_wdl_3"};
    backpack[] = {"vn_o_pack_t884_01"};
	backpackItems[] = {"vn_o_acc_goggles_03"};
    headgear[] = {"rhsusf_hgu56p_mask_black"};
    primaryWeapon[] = {};
    primaryAttachments[] = {};
...
class r : base {
	...
	attachment[] = {"CUP_muzzle_snds_XM8"};
	bipod[] = {"CUP_acc_ANPEQ_15_Top_Flashlight_Black_L"};
	secondaryAttachments[] = {};
    sidearmAttachments[] = {};
	magazines[] +=
    {
        LIST_10("CUP_30Rnd_556x45_PMAG_QP_Tracer_Yellow"),
        LIST_2("rhs_mag_m67"),
...
class ar : r
{
	...
	primaryAttachments[] = {"CUP_muzzle_snds_XM8","CUP_acc_ANPEQ_15_Top_Flashlight_Black_L","CUP_optic_CompM2_Black"};
	sidearmWeapon[] = {"rhsusf_weap_m9"};
	backpackItems[] +=
    {
        LIST_4("CUP_100Rnd_TE1_Yellow_Tracer_556x45_BetaCMag")
    };
    magazines[] =
    {
        LIST_4("CUP_100Rnd_TE1_Yellow_Tracer_556x45_BetaCMag"),
