...
class base {
    displayName = "base";
    uniform[] = {"OPTRE_UNSC_Army_Uniform_DES","OPTRE_UNSC_Army_Uniform_DES_SlimLeg","OPTRE_UNSC_Army_Uniform_R_DES","OPTRE_UNSC_Army_Uniform_R_DES_SlimLeg","OPTRE_UNSC_Army_Uniform_S_DES","OPTRE_UNSC_Army_Uniform_S_DES_SlimLeg"};
	vest[] = {"OPTRE_UNSC_M52A_Armor_Rifleman_DES"};
    sidearmWeapon[] = {"OPTRE_M6G_SF"};
	sidearmAttachments[] = {"OPTRE_M6G_Scope","OPTRE_M6G_Flashlight"};
    headgear[] = {"OPTRE_UNSC_CH252_Helmet2_DES"};
...
class g : r
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Grenadier_DES"};
    magazines[] +=
    {
...
class m : smg
{
	...
	headgear[] = {"OPTRE_UNSC_CH252_Helmet2_DES_MED"};
...
class dm : base
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Marksman_DES"};
...
{
    displayName = "Sniper";
	vest[] = {"OPTRE_UNSC_M52A_Armor_Sniper_DES"};
	headgear[] = {"OPTRE_UNSC_CH252_Helmet3_DES"};
...
class pp : vd
{
    ...
    headgear[] = {"OPTRE_UNSC_CH252_Helmet_Vacuum_DES"};
	items[] += {"ACRE_PRC148"};
};
class pcc : vd
{
...
class sh : smg
{
	...
	vest[] = {"OPTRE_UNSC_M52A_Armor_Breacher_DES"};
