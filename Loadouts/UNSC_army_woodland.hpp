...
class base {
    displayName = "base";
    uniform[] = {"OPTRE_UNSC_Army_Uniform_WDL","OPTRE_UNSC_Army_Uniform_WDL_SlimLeg","OPTRE_UNSC_Army_Uniform_R_WDL","OPTRE_UNSC_Army_Uniform_R_WDL_SlimLeg","OPTRE_UNSC_Army_Uniform_S_WDL","OPTRE_UNSC_Army_Uniform_S_WDL_SlimLeg"};
