class base {
    displayName = "base";
    uniform[] = {"CUP_I_B_PMC_Unit_29","CUP_I_B_PMC_Unit_26"};
    ...
    sidearmAttachments[] = {};
    magazines[] = {};
    items[] = {"ACRE_PRC343","ACE_elasticBandage","ACE_elasticBandage","ACE_packingBandage","ACE_packingBandage","ACE_IR_Strobe_Item","ACE_morphine","ACE_splint","ACE_tourniquet","CUP_PMC_Facewrap_Black","ACE_Chemlight_White","CUP_G_PMC_Facewrap_Winter_Glasses_Dark"};
...
class smg : r
{
    ...
    primaryWeapon[] = {"CUP_arifle_X95_gripod"};
	primaryAttachments[] = {};
    magazines[] =
    {
        LIST_8("CUP_30Rnd_556x45_X95"),
		LIST_2("rhs_mag_m67"),
		LIST_1("rhs_mag_an_m8hc"),
    };
};
...
class sl : ftl
{
	...
	items[] += {"ACRE_PRC148","immersion_cigs_cigar0",};
	magazines[] +=
	{
		LIST_3("rhsusf_mag_17Rnd_9x19_JHP"),
		LIST_1("murshun_cigs_matches")
	};
    linkedItems[] =
    {
        "ItemMap",
...
class ar : r
{
    ...
    magazines[] =
    {
        LIST_4("CUP_100Rnd_556x45_BetaCMag"),
		LIST_1("rhs_mag_m67"),
		LIST_1("rhs_mag_an_m8hc"),
		LIST_3("rhsusf_mag_17Rnd_9x19_JHP")
    };
